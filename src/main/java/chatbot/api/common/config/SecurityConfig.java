...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
                //허용하는 url 설정
                .antMatchers("/auth/**", "/oauth2/**", "/hubInfo/**", "/hubUser", "/hub/**", "/userToken", "/module/ac/{command}/v1", "/hub/{hubId}/roles", "/module/type", "/hub/id", "/module/id", "/command/code", "/command/type", "/redis/**", "/user/**", "/**")
                    .permitAll()
