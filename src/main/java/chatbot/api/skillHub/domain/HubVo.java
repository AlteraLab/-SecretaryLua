...
public class HubVo {
    ...
    @Size(min = 16, max = 16, message = "허브 이름은 16자를 넘을 수 없습니다.")
    @JsonProperty("hub_name")
    @NotNull
    private String name;

    @Size(min = 16, max = 16, message = "허브 설명은 16자를 넘을 수 없습니다.")
    @JsonProperty("hub_descript")
    private String desc;

    @Size(min = 20, max = 20, message = "검색용 아이디는 20자를 넘을 수 없습니다.")
    @JsonProperty("search_id")
    @NotNull
    private String searchId;

    @Size(min = 17, max = 17, message = "유효하지 못한 MAC Address 입니다.")
